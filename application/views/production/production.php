        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="center" title="Sort" id="production_code">Kode Produksi</th>
                    <th class="center" title="Sort" id="production_name">Nama Barang</th>
                    <?php if (is_superadmin()) : ?>
                        <th class="center" title="Sort" id="division">Divisi</th>
                    <?php endif; ?>
                ...
                <tr>
                    <th></th>
                    <th class="left"><input type="text" placeholder="Search" class="cari" id="search_code" style="width:150px;"></th>
                    <th class="left"><input type="text" placeholder="Search" class="cari" id="search_name" style="width:120px;"></th>
                    <?php if (is_superadmin()) : ?>
