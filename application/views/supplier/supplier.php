        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="center" title="Sort" id="supplier">Supplier <span></span></th>
                    <th class="center" title="Sort" id="supplier_pic">PIC <span></span></th>
                    <th class="center" title="Sort" id="supplier_address">Alamat <span></span></th>
                    <th class="center" style="width:130px;" >Action</th>
                </tr>
                <tr>
                    <th></th>
                    <th class="left"><input type="text" placeholder="Search" class="cari" id="search_supplier" style="width:150px;"></th>
                    <th class="left"><input type="text" placeholder="Search" class="cari" id="search_pic" style="width:120px;"></th>
