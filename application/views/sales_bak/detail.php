<section class="well animated fadeInUp">
        ...
        <div class="span8">
            <fieldset>
                ...
                <?php if (is_superadmin()) : ?>
                    <div class="row-fluid">
                        <div class="span12">
                            <label for="division">Divisi</label>: <?=$record['division']?>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="row-fluid">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="tableProduction">
                        <thead>
                            <tr>
                                ...
                                <th class="center" id="production_code">Kode Barang <span></span></th>
                        ...
                        <?php if (isset($record['productions']) && count($record['productions'])>0) : $i=0; $total_price=0; ?>
                            <?php foreach ($record['productions'] as $prod) : ?>
                                <tr id="row<?=$i?>">
                                    <td><?=($i+1)?></td>
                                    <td class="productionOption"><?=$prod['production_name']?></td>
                                    <td class="productionOption"><?=$prod['production_code']?></td>
    ...
    <div class="row-fluid">
        ...
        <div class="span6 text-right">
            <a class="btn btn-primary" href="<?=$print_url?>"><i class="icon-print"></i> Cetak Faktur</a>
