        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="center" title="Sort" id="item_category">Nama Barang</th>
                    <th class="center" title="Sort" id="item_name">Kode Barang</th>
                ...
                <tr>
                    <th></th>
                    <th class="left"><input type="text" placeholder="Search" class="cari" id="search_category" style="width:150px;"></th>
