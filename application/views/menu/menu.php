        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th title="Sort" id="menu">Menu <span></span></th>
                    <th title="Sort" id="parent_auth_menu">Parent <span></span></th>
                    <th title="Sort" id="file">File/Path <span></span></th>
                    <th title="Sort" id="position">Urutan <span></span></th>
                    <th class="center">Action</th>
                </tr>
                <tr>
                    <th></th>
                    <th><input type="text" placeholder="Search" class="cari" id="search_menu" style="width:150px;"></th>
                    <th><input type="text" placeholder="Search" class="cari" id="search_parent" style="width:150px;"></th>
                    <th><input type="text" placeholder="Search" class="cari" id="search_file" style="width:150px;"></th>
                    <th>&nbsp;</th>
                    <th>&nbsp;</th>
                </tr>
            </thead>
