                            ...
                            <?php if (isset($payments) && count($payments)>0) : $i=0; $total_price=0; ?>
                                <?php foreach ($payments as $payment) : ?>
                                    <tr id="row<?=$i?>">
                                        ...
                                        <td class="center"><?= ($payment['payment_image'] !='' && file_exists(IMG_UPLOAD_DIR.'division_purchase/'.$payment['payment_image'])) ? '<img class="thumb-gal" src="'.IMG_UPLOAD_DIR_REL.'/division_purchase/sml_'.$payment['payment_image'].'"/>' : '---' ?></td>
