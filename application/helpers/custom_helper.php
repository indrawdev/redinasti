...
/**
 * generate date and time with iso output
 * @author ivan lubis
 ...
 */
function date_time($date,$format='d-m-Y') {
...
function alert_box($msg = '', $type = '')
{
    ...
    if ($msg != '') {
        ...
        $html .= $msg;
        $html .= '&nbsp;<a href="#" class="close icon-remove-sign" data-dismiss="alert"></a>';
        $html .= '</div>';
    }
    return $html;
}
